...
namespace ModularStoreDeltaEncodedNS {
    ...
    void ModularStoreDeltaEncoded::add_document(Doc document) {
    ...
    void ModularStoreDeltaEncoded::add(std::string word, Doc document) {
    ...
    std::vector<Doc> ModularStoreDeltaEncoded::get(std::string word) {
    ...
    void ModularStoreDeltaEncoded::map_id_to_doc_nodes(std::vector<Doc> &res, std::vector<uint32_t> &ids) {
    ...
    int ModularStoreDeltaEncoded::get_num_docs() {
      return doc_nodes.n;
    }
}
