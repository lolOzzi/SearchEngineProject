...
namespace ModularStorePackedNS {
    ...
    inline void ModularStorePacked::add_document(Doc document) {
    ...
    inline void ModularStorePacked::add(std::string word, Doc document) {
    ...
    inline std::vector<Doc> ModularStorePacked::get(std::string word) {
    ...
    inline void ModularStorePacked::map_id_to_doc_nodes(std::vector<Doc> &res, std::vector<uint32_t> &ids) {
    ...
    inline int ModularStorePacked::get_num_docs() {
      return doc_nodes.n;
    }
}
