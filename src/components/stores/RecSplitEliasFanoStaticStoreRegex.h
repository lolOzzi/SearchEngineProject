...
namespace RecSplitEliasFanoStaticStoreNSRegex {
    ...
    class RecSplitEliasFanoStaticStoreRegex : public IStore, public ICompressible {
    private:
    ...
    public:
        RecSplitEliasFanoStaticStoreRegex();
        ~RecSplitEliasFanoStaticStoreRegex() override = default;
