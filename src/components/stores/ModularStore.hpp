...
namespace ModularStoreNS {
    ...
    inline void ModularStore::add_document(Doc document) {
    ...
    inline void ModularStore::add(std::string word, Doc document) {
    ...
    inline std::vector<Doc> ModularStore::get(std::string word) {
    ...
    inline void ModularStore::map_id_to_doc_nodes(std::vector<Doc> &res, std::vector<uint32_t> &ids) {
    ...
    inline int ModularStore::get_num_docs() {
      return doc_nodes.n;
    }
}
