...
namespace ModularStoreEliasFanoNoBufferNS {
    ...
    inline void ModularStoreEliasFanoNoBuffer::add_document(Doc document) {
    ...
    inline void ModularStoreEliasFanoNoBuffer::add(std::string word, Doc document) {
    ...
    inline std::vector<Doc> ModularStoreEliasFanoNoBuffer::get(std::string word) {
    ...
    inline void ModularStoreEliasFanoNoBuffer::map_id_to_doc_nodes(std::vector<Doc> &res, std::vector<uint32_t> &ids) {
    ...
    inline int ModularStoreEliasFanoNoBuffer::get_num_docs() {
      return doc_nodes.n;
    }
}
