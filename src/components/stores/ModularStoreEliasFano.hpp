...
namespace ModularStoreEliasFanoNS {
    ...
    inline void ModularStoreEliasFano::add_document(Doc document) {
    ...
    inline void ModularStoreEliasFano::add(std::string word, Doc document) {
    ...
    inline std::vector<Doc> ModularStoreEliasFano::get(std::string word) {
    ...
    inline void ModularStoreEliasFano::map_id_to_doc_nodes(std::vector<Doc> &res, std::vector<uint32_t> &ids) {
    ...
    inline int ModularStoreEliasFano::get_num_docs() {
      return doc_nodes.n;
    }
}
