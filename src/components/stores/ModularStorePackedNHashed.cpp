...
namespace ModularStorePackedNHashedNS {
    ...
    void ModularStorePackedNHashed::add_document(Doc document) {
    ...
    void ModularStorePackedNHashed::add(std::string word, Doc document) {
    ...
    std::vector<Doc> ModularStorePackedNHashed::get(std::string word) {
    ...
    void ModularStorePackedNHashed::map_id_to_doc_nodes(std::vector<Doc> &res, std::vector<uint32_t> &ids) {
    ...
    int ModularStorePackedNHashed::get_num_docs() {
      return doc_nodes.n;
    }
}
